...
======================================
Streamlit app for the research project:
"SHAP vs. LIME: An Empirical Comparison of Post-Hoc Explainability Methods"

All experiment logic (Experiments A-E) is adapted directly from the
project notebook / standalone scripts (01_setup_model.py ... 07_cost_vs_stability_scatter.py).
No research numbers are hand-typed as "results" — every number shown in the
Experiments and Computational Cost pages is computed live, right here, by the
same functions used in the notebook, and cached so repeat visits don't
